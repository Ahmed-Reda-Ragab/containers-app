        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <select class="form-select filter-datatable" id="{{ $id }}_filter_{{ $filter['name'] }}" {{ isset($filter['column']) ? 'data-column=' . $filter['column'] : '' }}
                        >
...
<script>
    ...
    $('.filter-datatable').on('change', function() {
        const columnIndex = parseInt($(this).data('column')); // ✅ FIXED
