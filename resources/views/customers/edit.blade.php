                    ...
                    <form action="{{ route('customers.update', $customer) }}" method="POST" id="customerForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('commercial_number') is-invalid @enderror"
                                           id="commercial_number" name="commercial_number" value="{{ old('commercial_number', $customer->commercial_number) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="telephone" class="form-label">{{ __('customers.telephone') }}</label>
                                <input type="text" class="form-control @error('telephone') is-invalid @enderror"
                                       id="telephone" name="telephone" value="{{ old('telephone', $customer->telephone) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="ext" class="form-label">{{ __('customers.ext') }}</label>
                                <input type="text" class="form-control @error('ext') is-invalid @enderror"
                                       id="ext" name="ext" value="{{ old('ext', $customer->ext) }}"
                                       placeholder="{{ __('customers.enter_ext') }}">
                                @error('ext')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="fax" class="form-label">{{ __('customers.fax') }}</label>
                                <input type="text" class="form-control @error('fax') is-invalid @enderror"
                                       id="fax" name="fax" value="{{ old('fax', $customer->fax) }}"
                                       placeholder="{{ __('customers.enter_fax') }}">
                                @error('fax')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
