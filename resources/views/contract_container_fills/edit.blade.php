        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Container Fill</h4>
                    <a href="{{ route('contract-container-fills.show', $contractContainerFill) }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Back to Container Fill
                    </a>
                </div>
                    ...
                    <form action="{{ route('contract-container-fills.update', $contractContainerFill) }}" method="POST">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('contract_id') is-invalid @enderror"
                                    ...
                                    @foreach($contracts as $contract)
                                        <option value="{{ $contract->id }}" {{ (old('contract_id', $contractContainerFill->contract_id) == $contract->id) ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('no') is-invalid @enderror"
                                       id="no" name="no" value="{{ old('no', $contractContainerFill->no) }}" required
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('client_id') is-invalid @enderror"
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}" {{ (old('client_id', $contractContainerFill->client_id) == $customer->id) ? 'selected' : '' }}>
                                            {{ $customer->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror"
                                           id="price" name="price" value="{{ old('price', $contractContainerFill->price) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('deliver_id') is-invalid @enderror"
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ (old('deliver_id', $contractContainerFill->deliver_id) == $user->id) ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('deliver_at') is-invalid @enderror"
                                       id="deliver_at" name="deliver_at" value="{{ old('deliver_at', $contractContainerFill->deliver_at->format('Y-m-d')) }}" required>
                                @error('deliver_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('expected_discharge_date') is-invalid @enderror"
                                       id="expected_discharge_date" name="expected_discharge_date" value="{{ old('expected_discharge_date', $contractContainerFill->expected_discharge_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('discharge_date') is-invalid @enderror"
                                       id="discharge_date" name="discharge_date" value="{{ old('discharge_date', $contractContainerFill->discharge_date ? $contractContainerFill->discharge_date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('discharge_id') is-invalid @enderror"
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ (old('discharge_id', $contractContainerFill->discharge_id) == $user->id) ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror"
                                       id="city" name="city" value="{{ old('city', $contractContainerFill->city) }}" required
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror"
                                          ...
                                          placeholder="Enter address">{{ old('address', $contractContainerFill->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                          ...
                                          placeholder="Enter notes (optional)">{{ old('notes', $contractContainerFill->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Container Fill
                            </button>
                        </div>
                    </form>
                </div>
